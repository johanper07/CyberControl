...
$pdf->Cell(57,7,'',0);
$pdf->Cell(100,7,'LISTADO DE CLIENTES PREFERENCIALES ',0);
$pdf->Ln(23);

$pdf->SetFont('Arial','B',10);

$pdf->Cell(33,8,'Nombres',0);
$pdf->Cell(27,8,'Cedula',0);
$pdf->Cell(38,8,'Telefono',0);
$pdf->Cell(49,8,'Correo',0);
...
$query = "SELECT nombre, cedula, telefono,  correo , comentarios FROM clientes";
$resultado = $conexion->query($query);

	while($fila = $resultado->fetch_assoc())
	{

		$pdf->Cell(29,6,($fila['nombre']),1,0,'L');
		$pdf->Cell(29,6,$fila['cedula'],1,0,'L');
		$pdf->Cell(22,6,($fila['telefono']),1,0,'L');
		$pdf->Cell(49,6,($fila['correo']),1,0,'L');
        $pdf->Cell(64,6,($fila['comentarios']),1,1,'L');
