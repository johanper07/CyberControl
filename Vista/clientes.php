...
<html lang="es">
    ...
    <aside>
        ...
        <div class="form">
            ...
            <form action="../controlador/validarAnalisisDeSeguridad.php" method="post">
            <table>
            <tr>
       ...
       <a href="Interfaz_1.PHP"> <img src="imagenes/Captura.png" class="ima1"> </a>
             <div class="barra">    <nav>
					<ul>
                        <li> <a href="javascript:openVentana();">Registros</a> </li>
                        <li> <a href="clientes2.php">Gestión de Usuarios</a> </li>
