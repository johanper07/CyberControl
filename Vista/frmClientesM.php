...
<html lang="es">
    ...
    <title> CYBER CONTROL</title>
        ...
        <link rel="stylesheet"  href="CSS/estiloClientesM.css">
        
    </head>
 <body>
    <header>
    Gestiona sin problemas los clientes mayoristas
 ...
 <table>
  ...
  <form action="../controlador/ingresarClientesM.php" method="post" >
    ...
    <td> <img src="Imagenes/call.png"><p>Telefono:</p>
        ...
        <input type="text" id="mail" name="direccion" placeholder="direccion.." /></td>
      ...
      <textarea type="text" id="username" name="comentarios" placeholder="Escriba sus comentarios aquí" rows="10" cols="45" >   </textarea></td>
       ...
       <input type="submit" name="button" id="button" value="Registrar Cliente" >
        ...
        <a href="PDF/reporteClientesMayoristas.php"><input type="submit" name="button" id="button" value="Generar Reporte" ></a>
         </div>
      </table>
...
<br>
    ...
    <table border="1">
        <thead>
        <th colspan="1"><a href="frmClientesM.php">Actualizar</a></th>
        <th colspan="8">Lista de Clientes Mayoristas</th>
        </thead>
     <tr>
         ...
         <td><a href="../Controlador/modificarClientesM.php?id=<?php echo $fila['id']; ?>">Modificar </a></td> 
          <td><a href="../Controlador/eliminarClientesM.php?id=<?php echo $fila['id']; ?>">Eliminar </a></td>    
